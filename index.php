          ...
          <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Anggaran (Bulan Ini)</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?php echo number_format($pemasukan_hari_ini, 2, ',', '.'); ?></div>
                </div>
                <div class="col-auto">

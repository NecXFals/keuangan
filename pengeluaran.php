...
WHERE tgl_pengeluaran = CURDATE() - INTERVAL 7 DAY");
  ...
  <div id="content">
    ...
    <h1 class="h3 mb-2 text-gray-800">Data Pengeluaran Keuangan Diskominfo</h1>
      <!-- Content Row -->
      <div class="row">
      ...
      <button type="button" class="btn btn-success" style="margin:5px" data-toggle="modal" data-target="#myModalTambah"><i class="fa fa-plus"> Tambah Pengeluaran</i></button>
      <a href="report/laporan-pengeluaran.php" target="_blank" rel="noopener noreferrer"><button type="button" class="btn btn-success" style="margin:5px" data-toggle="modal"><i class="fa fa-download"> Cetak Laporan</i></button></a>
      <br>
      <!-- DataTales Example -->
      <div class="row">
